...
const defaultValue = [
  {
    ...
    description: "Накидал быстрый макет на бумаги для раздела с книгами, получилось на первый взгляд неплохо, осталось это все сверстать и посмотреть на то, что по итогу получится, в основу идеи для данного раздела легла механика карусели."
  },
  {
    id: 1,
